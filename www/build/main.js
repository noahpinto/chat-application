...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_chat_chat__ = __webpack_require__(230);
...
var ChatPage = (function () {
    function ChatPage(db, navCtrl, navParams) {
        ...
        this._chatSubsription = this.db.list('/chat').valueChanges().subscribe(function (data) {
            console.log(data);
            /*data.map(elem =>{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_chat_chat__ = __webpack_require__(230);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\nodejs\chat_app\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\nodejs\chat_app\src\app\app.html"*/
        }),
